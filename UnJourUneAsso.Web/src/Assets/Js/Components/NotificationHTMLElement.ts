export default class NotificationHTMLElement extends HTMLElement{
    ...
    constructor (success: boolean, message: string, timeout: number = 3000) {
        super();
    ...
    connectedCallback(): void{
        const try_success : string|null = this.getAttribute('aria-success');
        ...
        const try_timeout = parseInt(<string>this.getAttribute('aria-timeout'));
